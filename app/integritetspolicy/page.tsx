...
export const metadata: Metadata = {
  ...
  description: "Information om hur Avtryck Digital hanterar dina personuppgifter.",
};
    ...
    <div className="pt-28 pb-24">
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="glass rounded-2xl p-8 border border-white/15 space-y-6 text-sm text-white/75 leading-relaxed">
          <p>
            Vi håller på att uppdatera vår integritetspolicy för att säkerställa att den uppfyller
            alla krav enligt GDPR och tillämplig svensk lagstiftning.
          </p>
          <p>
            Under tiden är du välkommen att kontakta oss direkt om du har frågor om hur vi hanterar
